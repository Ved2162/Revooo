        ...
        {quickActions.map((action) => {
          ...
          return (
            <Link key={action.href} href={action.href} className="group">
              <div
                className={`
                  relative p-4 border border-gray-200 dark:border-border rounded-lg 
                  transition-all duration-200 ease-in-out
                  ${action.hoverColor} ${action.borderColor}
                  dark:hover:bg-muted/40 dark:hover:border-primary/40
                  hover:shadow-lg hover:shadow-gray-100 dark:hover:shadow-none
              ...
              >
                ...
                <div className="flex justify-end mt-2">
                  <div className="w-5 h-5 rounded-full bg-gray-100 dark:bg-muted group-hover:bg-gray-200 dark:group-hover:bg-muted/80 flex items-center justify-center transition-colors duration-200">
                    <svg 
                      className="w-3 h-3 text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-200 transition-colors duration-200" 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
