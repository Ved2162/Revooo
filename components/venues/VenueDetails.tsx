              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex items-center gap-4">
                      {venue.rating && (
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-gray-500 dark:text-gray-400">({venue.totalReviews} reviews)</span>
                        </div>
                      )}
                  ...
                  <div className="text-right flex-shrink-0">
                    <div className="text-3xl font-bold text-green-600 dark:text-green-400">₹{lowestPrice}+</div>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {venue.operatingHours.map((hours) => (
                        <div key={hours.dayOfWeek} className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-border last:border-b-0">
                          <span className="font-medium">{getDayName(hours.dayOfWeek)}</span>
                          <span className={hours.isClosed ? 'text-red-600 dark:text-red-400' : 'text-gray-900 dark:text-white'}>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button className="w-full" size="lg" onClick={() => checkAuthForBooking(id)}>
                    Book Now
                  </Button>
