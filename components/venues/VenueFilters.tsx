...
export function VenueFilters({ 
  ...
  return (
    <Card className="sticky top-4 bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-800 shadow-sm">
      <CardHeader>
      ...
      <CardContent className="space-y-6">
        ...
        <div>
          ...
          <div className="space-y-3">
            {/* State - comes first */}
            <div>
              <Label htmlFor="state" className="text-xs text-gray-600 dark:text-gray-400 mb-1 block">
                State
              </Label>
              <Select 
            ...
            <div>
              <Label htmlFor="city" className="text-xs text-gray-600 dark:text-gray-400 mb-1 block">
