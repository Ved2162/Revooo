      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <img src="/revo-logo.svg" alt="REVO" className="h-8 w-8 rounded-lg" />
              <span className="text-xl font-bold">REVO</span>
            </div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">support@revo.in</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 py-4">
          <div className="text-center text-xs text-gray-500">
            <p>
              REVO is a sports venue booking platform. All bookings are subject to availability and venue policies.
            </p>
            <p className="mt-1">
              For business inquiries: business@revo.in | Partner with us: partners@revo.in
            </p>
          </div>
        </div>
      </div>
