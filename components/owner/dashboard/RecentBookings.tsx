              ...
              >
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="font-medium text-gray-900 dark:text-white">{booking.user.name}</span>
                  ...
                  <div className="mt-1 text-sm">
                    <span className="text-gray-600 dark:text-gray-400">{booking.court.name} • </span>
                    <span className="text-gray-600 dark:text-gray-400 capitalize">{booking.court.sportType}</span>
                  </div>
                </div>
